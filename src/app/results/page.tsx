...
export default function ResultsPage() {
  ...
  if (!ready)
    return (
      <div className="page-content empty-state" role="status">
    ...
    return (
      <div className="page-content">
        <div className="empty-state results-empty">
          ...
          <div className="eyebrow">YOUR CITY’S NEXT CHAPTER</div>
          <h1>Every result starts with a decision.</h1>
          <p>
            Choose five initiatives and run your strategy to discover its
            impact.
          </p>
          <Link href="/simulation" className="button button-primary">
            Build your strategy <ArrowUpRight size={18} />
          </Link>
        </div>
      </div>
    );
  return (
    <div className="page-content">
      <div className="page-heading">
        <div>
          <div className="eyebrow">YOUR DECISIONS. THEIR IMPACT.</div>
          <h1>A new outlook for Astana.</h1>
          <p>Explore how the city changed, district by district.</p>
        </div>
        <Link href="/simulation" className="button button-secondary">
          <ArrowLeft size={16} /> Refine your strategy
        </Link>
      </div>
